      ...
      <div class="container">
        <div class="inventory-header">
          <div class="header-left">
            <div class="heading">Import Truck</div>
          </div>
        ...
        <div class="inventory-body">
          <div class="product-filters">
            ...
            <div class="filters-right">
              <div id="addProduct"><font-awesome-icon icon="fa-solid fa-plus" /> Add Product</div>
              <div id="addProduct"><font-awesome-icon icon="fa-solid fa-plus" /> New Product</div>
              <div id="scanner">START SCAN</div>
            </div>
          </div>
...
#addProduct{
  ...
  cursor: pointer;
  border-radius: 6px;
  border: 5px double var(--color-black);
...
.item-container .item > div,
.item-container .item-list-head > div{
  flex-basis: 50%;
}
.item .item-left,
.item-container .item-list-head .item-left,
.item-container .item-list-head .item-right,
.item .item-right{
  display: flex;
  align-items: center;
}
...
.item-container .edit-btn{
  min-width: 40px;
}
.item-container .item-list-head .item-right > div,
.item .item-right > div{
  min-width: 120px;
  text-align: center;
}
...
.item-container .item-list-head .item-right > div.category,
.item .item-right > div.category{
  min-width: 160px;
}
.item-list-head div{
  font-weight: 700;
...
.clearBtn{
  ...
  border: 5px double var(--color-text-light);
