...
<template>
    <div class="col-block">
        ...
        <div class="all-message-container">
            <div class="message" :class="{ important: message.level }" v-for="(message, index) in messages" :key="index">
              <div class="message-meta" ><div class="posted-by">By <strong v-html="message.author"></strong></div><div class="posted-on">Posted on <strong v-html="message.date"></strong></div></div>
              <div class="message-text" @click="openModal(message)" v-if="message.message" v-html="message.message"></div>
            </div>
        </div>
    </div>
</template>
